...
class GoamlController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'incorporation_country_code'=> 'required|string|size:3',
            ...
            'nationality1'   => 'required|string|size:3',
            'residence'      => 'required|string|size:3',
    ...
    public function saveSettings(Request $request)
    {
        ...
        $request->validate([
            ...
            'entity_country_code'=> 'required|string|size:3',
            ...
            'mlro_nationality'   => 'required|string|size:3',
