...
class PublicContentSeeder extends Seeder
{
    ...
    {
        $rows = [
            ['title' => 'Trade License Renewal', 'description' => 'Renew your DED trade license before expiry to avoid a lapse in your DNFBP registration status. Your renewal date depends on when your license was issued — track your own date in My Deadlines.', 'sector' => null, 'category' => 'licensing', 'authority' => 'Dept. of Economic Development', 'recurrence' => 'annual', 'next_due_date' => null],
            ['title' => 'DNFBP goAML Registration Renewal', 'description' => 'Confirm your goAML reporting entity registration and MLRO details remain current with the UAE Financial Intelligence Unit. Your renewal date depends on your original registration date — track your own date in My Deadlines.', 'sector' => null, 'category' => 'goaml', 'authority' => 'UAE FIU / goAML', 'recurrence' => 'annual', 'next_due_date' => null],
            ...
            ['title' => 'Annual AML/CFT Risk Assessment Review', 'description' => 'Review and update your business-wide AML/CFT risk assessment to reflect current customer, geographic and product risk. Schedule this around your own review cycle — track your own date in My Deadlines.', 'sector' => null, 'category' => 'reporting', 'authority' => null, 'recurrence' => 'annual', 'next_due_date' => null],
            ['title' => 'UBO Register Update', 'description' => 'Confirm beneficial ownership information filed with the registrar is current, including any changes in shareholding structure. Timing depends on your own filing history — track your own date in My Deadlines.', 'sector' => 'company_services', 'category' => 'licensing', 'authority' => null, 'recurrence' => 'annual', 'next_due_date' => null],
            ['title' => 'Staff AML/CFT Training', 'description' => 'Deliver refresher AML/CFT training to all relevant staff, covering red flags, STR procedures and sanctions obligations. Every business runs its own training schedule — track your own date in My Deadlines.', 'sector' => null, 'category' => 'training', 'authority' => null, 'recurrence' => 'annual', 'next_due_date' => null],
            ...
            ['title' => 'Ejari Contract Renewal', 'description' => 'Renew Ejari tenancy contracts tied to your registered business premises. Your renewal date depends on your own tenancy contract — track your own date in My Deadlines.', 'sector' => 'real_estate', 'category' => 'licensing', 'authority' => null, 'recurrence' => 'annual', 'next_due_date' => null],
            ['title' => 'CAHRA List Review', 'description' => 'Review your Countries with AML/CFT deficiencies (CAHRA) list against the latest FATF and local guidance, and reassess exposed clients. Set this on your own quarterly cadence — track your own date in My Deadlines.', 'sector' => null, 'category' => 'screening', 'authority' => null, 'recurrence' => 'quarterly', 'next_due_date' => null],
