        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('dashboard') }}"
               class="flex items-center px-3 py-2 rounded-md text-sm font-medium
                      {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
            ...
            <div class="pt-3">
                ...
                <a href="{{ route('tasks.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('tasks.index') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('training-sessions.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('training-sessions.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-3">
                ...
                <a href="{{ route('kyc.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('kyc.index') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('kyc.tenants') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('kyc.tenants*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('screening.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('screening.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    Screening
            ...
            <!-- Public Site -->
            <div class="pt-3">
                <p class="px-3 text-xs font-semibold text-blue-300 uppercase tracking-wider">Public Site</p>

                <a href="{{ route('content.deadlines.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('content.deadlines.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('content.resources.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('content.resources.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Resources
                ...
                <a href="{{ route('content.news.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('content.news.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>
                    </svg>
                    News Feed
                ...
                <a href="{{ route('content.public-users.index') }}"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium
                          {{ request()->routeIs('content.public-users.*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-3.13a4 4 0 10-4-4 4 4 0 004 4zm6 4a4 4 0 10-4-4"/>
                    </svg>
                    Public Users
                </a>
            </div>

            <!-- Bottom divider + Help + Settings -->
            <div class="pt-3 border-t border-blue-600 mt-2">
                <a href="{{ route('help.user-manual') }}" target="_blank"
                   class="mt-1 flex items-center px-3 py-2 rounded-md text-sm font-medium text-blue-100 hover:bg-blue-600">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
