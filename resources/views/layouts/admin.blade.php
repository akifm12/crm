        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="flex items-center px-3 py-2 rounded-md text-sm font-medium
                      {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
            ...
            <!-- KYC Management -->
            <div class="pt-3">
                <p class="px-3 text-xs font-semibold text-blue-300 uppercase tracking-wider">KYC & Onboarding</p>
			...
			<div class="border-t border-blue-600 mx-3 my-2"></div>
			<a href="{{ route('settings.index') }}"
			   class="mx-3 flex items-center px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('settings*') ? 'bg-blue-600 text-white' : 'text-blue-100 hover:bg-blue-600' }}">
				<svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
